...
// Source: github.com/clocklear/pirelayserver/cmd/pirelayserver/internal/config (interfaces: Configurer)

// Package mocks is a generated GoMock package.
package mocks

import (
	config "github.com/clocklear/pirelayserver/cmd/pirelayserver/internal/config"
...
func (m *MockConfigurer) Get() (config.Config, error) {
	m.ctrl.T.Helper()
...
func (m *MockConfigurer) Set(arg0 config.Config) error {
	m.ctrl.T.Helper()
